...
* Searching the GEO database for gene expression datasets.

* Analysing GEO microarray datasets.

* Analysing user uploaded microarray and RNAseq datasets.

* Merging multiple gene expression datasets and performing batch correction.
