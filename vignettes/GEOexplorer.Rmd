...
A video demonstrating how to use GEOexplorer's user interface is embedded below or can be seen on the following [link] (https://youtu.be/8R8yqMlPCVM) .

```{r eval=FALSE}
library("vembedr")
embed_url("https://youtu.be/8R8yqMlPCVM")
```
