...
available databases. Additionally, GEOexplorer does not require programming proficiency or in-depth statistical knowledge to use.
...
Note: to process GEO RNA seq gene expression datasets: the user must first 
download the RNA seq gene expression dataset and convert it into the template 
format mentioned in the next section, then upload it to GEOexplorer.
