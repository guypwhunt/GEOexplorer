...
for help. If you are convinced that there is a bug in GEOexplorer(this
is pretty unusual, but not unheard of), feel free to submit an issue on
the [GEOexplorer github site](https://github.com/guypwhunt/GEOexplorer).
