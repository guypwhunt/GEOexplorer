...
to the expression data, as per the image below.

![](Picture3.png)

Step 4: Select if you want missing data to be estimated using KNN
imputation, as per the image below.
...
Analysis** tab, as per the image below.

![](Picture7.png)

Step 8: Click on the tabs to view the interactive exploratory data
analysis visualisations, as per the image below. These visualisations
give insights into the trends within the expression data such as the
...
**Differential Gene Expression Analysis** tab, as per the image below.

![](Picture9.png)

Step 2: Click on the **Set Parameters** tab, as per the image below.

![](Picture10.png)

Step 3: Assign each experimental condition into group 1, group 2 or N/A,
as per the image below. Experimental condition assigned to N/A will not
be included in differential gene expression analysis whilst those
assigned to group 2 will be compared to those assigned to group 1.
...
image below. The limma precision weights improve the accuracy of
...
Step 6: Select whether to force normalisation, as per the image below.
...
Step 7: Select the significance cut off, as per the image below. The cut
off will be used to identify the genes that are under-expressed and the
...
the subsequent tabs, as per the image below.
...
for help. If you are convinced that there is a bug in GEOexplorer, feel free to submit an issue on
the [GEOexplorer github site](https://github.com/guypwhunt/GEOexplorer). Please include the GEO accession code that
errors and the operating system
