...
test_that("Microarray GSE with missing values is handled correctly with nonInteractiveDensityPlot", {
  ...
  fig <- nonInteractiveDensityPlot(ex = naOmitInput, geoAccessionCode = 'GSE18380', platform = platform)
