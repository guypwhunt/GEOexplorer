library(GEOexplorer)
context("interactiveUmapPlot")

test_that("Microarray GSE without missing values is handled correctly by the interactive UMAP plot", {
...
test_that("Microarray GSE with missing values  is handled correctly by the interactive UMAP plot", {
