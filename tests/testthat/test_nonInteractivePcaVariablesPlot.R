library(GEOexplorer)
context("nonInteractivePcaVariablesPlot")

test_that("Microarray GSE without missing values is handled correctly with nonInteractivePcaVariablesPlot", {
...
test_that("Microarray GSE with missing values is handled correctly with nonInteractivePcaVariablesPlot", {
