library(GEOexplorer)
context("interactivePrincompPcaScreePlot")

test_that("Microarray GSE without missing values is handled correctly by interactivePrincompPcaScreePlot", {
...
test_that("Microarray GSE with missing values  is handled correctly by interactivePrincompPcaScreePlot", {
