library(GEOexplorer)
context("interactivePrcompPcaVariablesPlot")

test_that("Microarray GSE without missing values is handled correctly by interactivePrcompPcaVariablesPlot", {
...
test_that("Microarray GSE with missing values  is handled correctly by interactivePrcompPcaVariablesPlot", {
