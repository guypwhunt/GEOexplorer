library(GEOexplorer)
context("interactivePrcompPcaScreePlot")

test_that("Microarray GSE without missing values is handled correctly by interactivePrcompPcaScreePlot", {
...
test_that("Microarray GSE with missing values  is handled correctly by interactivePrcompPcaScreePlot", {
