library(GEOexplorer)
context("nonInteractivePcaIndividualsPlot")

test_that("Microarray GSE without missing values is handled correctly with nonInteractivePcaIndividualsPlot", {
...
test_that("Microarray GSE with missing values is handled correctly with nonInteractivePcaIndividualsPlot", {
