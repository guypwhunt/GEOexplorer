library(GEOexplorer)
context("interactiveQQPlot")

test_that("Microarray GSE without missing values is handled correctly with interactiveQQPlot", {
...
test_that("Microarray GSE with missing values is handled correctly with interactiveQQPlot", {
