...
test_that("Microarray GSE with missing values is handled correctly with nonInteractiveBoxAndWhiskerPlot", {
  ...
  fig <- nonInteractiveBoxAndWhiskerPlot(ex = expressionData, geoAccessionCode = 'GSE18380', platform = platform)
