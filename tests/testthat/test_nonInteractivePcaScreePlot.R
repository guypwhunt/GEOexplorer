library(GEOexplorer)
context("nonInteractivePcaScreePlot")

test_that("Microarray GSE without missing values is handled correctly with nonInteractivePcaScreePlot", {
...
test_that("Microarray GSE with missing values is handled correctly with nonInteractivePcaScreePlot", {
