...
test_that("Microarray GSE with missing values is handled correctly with interactiveBoxAndWhiskerPlot", {
  ...
  fig <- interactiveBoxAndWhiskerPlot(expressionData, 'GSE18380', platform)
  expect_type(fig, 'list')
  expect_type(fig[1], 'list')
  expect_type(fig$elementId, 'NULL')
  expect_type(fig$height, 'NULL')
