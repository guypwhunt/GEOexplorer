library(GEOexplorer)
context("interactiveHistogramPlot")

test_that("Microarray GSE without missing values is handled correctly with interactiveHistogramPlot", {
...
test_that("Microarray GSE with missing values is handled correctly with interactiveHistogramPlot", {
