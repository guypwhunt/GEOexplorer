library(GEOexplorer)
context("interactivePrcompPcaIndividualsPlot")

test_that("Microarray GSE without missing values is handled correctly by interactivePrcompPcaIndividualsPlot", {
...
test_that("Microarray GSE with missing values  is handled correctly by interactivePrcompPcaIndividualsPlot", {
