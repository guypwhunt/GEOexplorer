library(GEOexplorer)
context("interactiveDensityPlot")

test_that("Microarray GSE without missing values is handled correctly by the interactive density plot", {
...
test_that("Microarray GSE with missing values  is handled correctly by the interactive density plot", {
