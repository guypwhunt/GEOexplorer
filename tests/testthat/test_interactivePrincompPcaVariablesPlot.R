library(GEOexplorer)
context("interactivePrincompPcaVariablesPlot")

test_that("Microarray GSE without missing values is handled correctly by interactivePrincompPcaVariablesPlot", {
...
test_that("Microarray GSE with missing values  is handled correctly by interactivePrincompPcaVariablesPlot", {
