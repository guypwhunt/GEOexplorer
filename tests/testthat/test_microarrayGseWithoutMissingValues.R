...
test_that("Microarray GSE without missing values is handled correctly by all functions", {
  # Input Values
  ...
  expect_equal(ei[5], "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE18388", ignore_attr = TRUE)
  ...
  expect_equal(extractedExperimentInformation[1], "<b> Paper Title: </b> <p> Microarray Analysis of Space-flown Murine Thymus Tissue </p><b> Author's Name: </b> <p> Ty,W,Lebsack </p><b> Laboratory: </b> <p>  </p><b> Contact Information: </b> <p> lebsack@email.arizona.edu </p><b> Paper URL: </b> <p> https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE18388 </p><b> PubMed ID: </b> <p> 20213684 </p><b> Abstract: </b> <p> Microarray Analysis of Space-flown Murine Thymus Tissue Reveals Changes in Gene Expression Regulating Stress and Glucocorticoid Receptors. We used microarrays to detail the gene expression of space-flown thymic tissue and identified distinct classes of up-regulated genes during this process. We report here microarray gene expression analysis in young adult C57BL/6NTac mice at 8 weeks of age after exposure to spaceflight aboard the space shuttle (STS-118) for a period of 13 days. Upon conclusion of the mission, thymus lobes were extracted from space flown mice (FLT) as well as age- and sex-matched ground control mice similarly housed in animal enclosure modules (AEM). mRNA was extracted and an automated array analysis for gene expression was performed. Examination of the microarray data revealed 970 individual probes that had a 1.5 fold or greater change. When these data were averaged (n=4), we identified 12 genes that were significantly up- or down-regulated by at least 1.5 fold after spaceflight (pâ‰¤0.05). Together, these data demonstrate that spaceflight induces significant changes in the thymic mRNA expression of genes that regulate stress, glucocorticoid receptor metabolism, and T cell signaling activity. These data explain, in part, the reported systemic compromise of the immune system after exposure to the microgravity of space. </p>")
