library(GEOexplorer)
context("nonInteractiveQQPlot")

test_that("Microarray GSE without missing values is handled correctly with nonInteractiveQQPlot", {
...
test_that("Microarray GSE with missing values is handled correctly with nonInteractiveQQPlot", {
