  ...
  mainPanel(tabsetPanel(type = "tabs",
                        ...
                        tabPanel("Exploratory Data Analysis",
                                 tabsetPanel(type = "tabs",
                                             ...
                                             tabPanel("Heatmap Plot", br(), span("Generated using R cor and heatmaply. The plot below compares the correlation values of the samples in a heat map."), br(), br(), plotlyOutput('interactiveHeatMapPlot')),
